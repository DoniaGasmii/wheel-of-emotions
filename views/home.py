...
def show():
    ...
    .landing-sub {
        font-size: 17px; color: #888; margin-bottom: 40px; line-height: 1.6;
    }
    .section-label {
    ...
    .wheel-card {
        ...
        padding: 24px; background: #0f0f1a;
        text-align: center; cursor: pointer;
        transition: border-color 0.2s;
    }
    .wheel-card:hover { border-color: #7c8ff0; }
    ...
    with col1:
        ...
        """, unsafe_allow_html=True)
        st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Plutchik-wheel.svg/400px-Plutchik-wheel.svg.png",
                use_container_width=True, caption="Reference: Plutchik emotion wheel")
    ...
    with col2:
        st.markdown("""
        <div class="wheel-card">
            <div class="card-title">✏️ Custom wheel</div>
